...
<!-- Wrapper for the radial gradient background -->
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Module/install");?>"><span>
				...
				<div class="content-box-content">
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                    	<div class="notification information png_bg">
							...
							<div>
								本系统采用模块化开发，可自由启用各种模块，以满足不同的使用需求。<br />禁用：禁用后不能管理该模块，可重新启用；卸载：彻底从系统中删除该模块，此操作不可恢复，请谨慎操作。
							</div>
						</div>
						<table>
							<thead>
							...
							<tbody>
<?php if(is_array($install)): $i = 0; $__LIST__ = $install;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($vo["module_title"]); ?>(<strong><?php echo ($vo["module_name"]); ?></strong>)</td>
									<td><?php echo ($vo["developer"]); ?></td>
									<td><?php echo ($vo["module_name"]); ?>Action.class.php</td>
									<td><?php echo ($vo["build_version"]); ?></td>
									<td>
										<!-- Icons -->
										 <a href="<?php echo U("Module/modify",array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/Images/icons/pencil.png" alt="编辑" /></a>
										 <a href="<?php echo U("Module/uninstall",array('id'=>$vo['id']));?>" title="卸载"><img src="__PUBLIC__/Admin/Images/icons/cross.png" alt="卸载" /></a> 
									</td>
...
<?php if(is_array($system)): $i = 0; $__LIST__ = $system;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($vo["module_title"]); ?>(<strong><?php echo ($vo["module_name"]); ?></strong>)</td>
									<td><?php echo ($vo["developer"]); ?></td>
									<td><?php echo ($vo["module_name"]); ?>Action.class.php</td>
									<td><?php echo ($vo["build_version"]); ?></td>
...
<?php if(is_array($disble)): $i = 0; $__LIST__ = $disble;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($vo["module_title"]); ?>(<strong><?php echo ($vo["module_name"]); ?></strong>)</td>
									<td><?php echo ($vo["developer"]); ?></td>
									<td><?php echo ($vo["module_name"]); ?>Action.class.php</td>
									<td><?php echo ($vo["build_version"]); ?></td>
